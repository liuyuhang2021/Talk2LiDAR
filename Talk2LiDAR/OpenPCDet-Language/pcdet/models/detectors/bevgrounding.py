...
class BevGrounding(Detector3DTemplate):
    ...
    # batch_dict['spatial_features_img']: [B, 80, H, W]
    ...
    # 新增： batch_dict['image_features']： list(length=3) [B*N, C, H, W]
    ...
    # 新增: batch_dict['spatial_features']: [B 256 H W]
