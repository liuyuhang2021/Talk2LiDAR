...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        model_info_dict = {
            ...
            'point_cloud_range': self.dataset.point_cloud_range,  # [-54.0, -54.0, -5.0, 54.0, 54.0, 3.0]
    ...
    # batch_dict['voxels'], ['voxel_num_points'], ['voxel_features']
    ...
    #  batch_dict['voxel_features'], ['voxel_coords'], ['batch_size']
    #  新增：batch_dict['encoded_spconv_tensor'], ['encoded_spconv_tensor_stride'}: 8,
    #  ['multi_scale_3d_features']: dict, ['multi_scale_3d_strides']: dict
    ...
    # 新增： batch_dict['spatial_features']: (B, 256, H, W), ['spatial_features_stride']: 8
    ...
    # 新增： batch_dict['spatial_features_2d']: [B, 256, H, W]
