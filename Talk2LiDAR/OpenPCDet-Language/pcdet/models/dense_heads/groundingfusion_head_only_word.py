...
from ..model_utils.transfusion_utils import PositionEmbeddingLearned, TransformerDecoderLayer, TransformerDecoderLayer_Text
...
class GroundingFusionHead_OnlyWord(nn.Module):
    """
    ...
    def __init__(
        ...
        super(GroundingFusionHead_OnlyWord, self).__init__()
        ...
        self.word_decoder = TransformerDecoderLayer_Text(hidden_channel, num_heads, ffn_channel, dropout, activation,
    ...
    def predict(self, inputs, word_feature):
    ...
    def forward(self, batch_dict):
        ...
        word_feature = batch_dict['word_feature']  # B 77 128

        res = self.predict(feats, word_feature)
