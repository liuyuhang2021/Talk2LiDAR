...
def create_nuscenes_info(version, data_path, save_path, max_sweeps=10, with_cam=False):
    ...
    train_scenes = set([available_scenes[available_scene_names.index(s)]['token'] for s in train_scenes])  # train的场景token
...
if __name__ == '__main__':
    ...
    if args.func == 'create_nuscenes_infos':
        ...
        dataset_cfg.VERSION = args.version  # 'v1.0-trainval'
        create_nuscenes_info(
            version=dataset_cfg.VERSION,  # 'v1.0-trainval'
