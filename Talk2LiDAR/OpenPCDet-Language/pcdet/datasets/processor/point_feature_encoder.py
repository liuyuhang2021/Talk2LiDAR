...
class PointFeatureEncoder(object):
    def __init__(self, config, point_cloud_range=None):
        ...
        self.used_feature_list = self.point_encoding_config.used_feature_list  # ['x', 'y', 'z', 'intensity', 'timestamp']
        self.src_feature_list = self.point_encoding_config.src_feature_list  # ['x', 'y', 'z', 'intensity', 'timestamp']
